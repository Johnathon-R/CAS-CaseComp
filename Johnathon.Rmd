...
To implement a fix for few premiums dominating the outcomes we will quantile the data.
...
priced_cov <- model_cov2 %>%
  ...
  mutate(relativity_cov = pure_cov / base_pure_cov)
